 ...
 - (UIButton *)createButtonWithImage:(id)imageNameOrImage andSeletor : (SEL)selector
{
 ...
 - (void)layoutSubviews
 {
        [super layoutSubviews];
         ...
         CGFloat btnW = self.theimageW;
         CGFloat btnH = self.theimageW;
        int maxColumn = kMaxColumn > self.frame.size.width / self.theimageW ? self.frame.size.width / self.theimageW : kMaxColumn;
