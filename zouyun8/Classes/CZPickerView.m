...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor colorWithRed:217/255.0 green:43/255.0 blue:73/255.0 alpha:1];
        ...
        self.confirmButtonBackgroundColor = [UIColor colorWithRed:217/255.0 green:43/255.0 blue:73/255.0 alpha:1];
...
- (UITableView *)buildTableView{
    ...
    if(n > 0){
        float height = n * CZP_HEADER_HEIGHT;
